...
################################################ 
################################################
$info[0]=strtolower($_POST['algoSi']); //ID_Proceso
$info[1]=strtolower($_POST['algoNo']); //Carreras
...
if($r ==1)
{
    echo "<script> 
                ...
                $('#nuebe ').addClass('atractivo');
                setTimeout(
                    function(){
                        $('#nuebe ').removeClass('atractivo');
                        $('#nuebe ').addClass('listacono');
                        },1000 
                    );
         </script>";  // bien 
} 
