...
// }
if ($respuesta== 7) {
  echo "<script> swal ('Disculpe' , 'El proceso de Repitencia no esta Habilitado Aun' , 'warning');</script>";
  die();
}
if ($Qpasa4 == 8) {
  echo "<script> swal ('Disculpe' , 'El proceso de Repitencia no ha empezado Aun.. Comienza para $Qpasa3 ' , 'warning');</script>";
  die();
}
if ($Qpasa2== 3) {
...
if ($Qpasa4== 9) {
  echo "<script> swal ('Disculpe' , 'No Hay Procesos De Repitencia En Estos Momentos! ' , 'info');</script>";
  die();
}
if ($Qpasa4== 5) {
  echo "<script> swal ('Disculpe' , 'Intente De Nuevo' , 'info');</script>";
...
else 
{
  ...
  if ($Qpasa2 == 4) 
  {
    echo "<script> swal ('Aviso' , 'Aun No Ha Realizado Su Proceso De Repitencia' , 'info');</script>";
  }
    ?>
...
<div class="TRMparte3">
        ...
        <div class="chaoQ">
            <h3 class="TRMparte3-1" > <input type="button" value="Enviar" id="intenzo1212">   </h3>
...
{  
  $("#intenzo1212").click(function (){
                ...
                var url  = '../Recuperacion/Guardar_rp.php'; 
                // Mostar  
                // console.log(data);  
