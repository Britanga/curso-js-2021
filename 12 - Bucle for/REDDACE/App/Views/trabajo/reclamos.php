...
session_start();
    ...
    $tabla= new desiciones($donde='Historial',$info,$opc='Reclamos');
    $r= $tabla->realizar();
      ...
      <div class="mapa" >
         <nav aria-label="breadcrumb"  >
             <ol class="breadcrumb radius-1rem2r " style="margin-bottom:2px; padding-bottom: 9px">
                  ...
                  <li class="breadcrumb-item active text-center" aria-current="page"> 
                      <i class="icon icon-home"></i> 
                      <a class="colorr" href="#">Reclamos</a>
                  </li>
             </ol>
         </nav>
     </div> 
...
{ 
            if ($array_s != null || $array_s != "") 
            {
                ...
                $html= "<tr id="."a".$Cedula."> 
                    ...
                    <td>".$array_s['Error']." </td> 
                    <td>".$array_s['Original']." </td>
                    <td><textarea class='vetasr' name=".'a'.$array_s['ID_Peticiones']."  id=".'a'.$array_s['ID_Peticiones']."  cols='10' rows='10'></textarea></td>
                    <td id='opc-iz'>         
                   ...
                   $.ajax({
                       type:".'"POST"'.",
                       url:".'"../Aprobar/Reclamo.php"'.",
                       data:".'"Procesos="'."+".$array_s['ID_Peticiones']."+".'"&Cedula="'."+".$info[0]." +".'"&msg="+msg'." ,
                       success: function(data){
                        swal (".'"Listo"'." , ".'"El Reclamo fue Aprobada"'." , ".'"success"'.");  
              ...
              $.ajax({
                  type:".'"POST"'.",
                  url:".'"../Rechazar/Reclamo.php"'.",
                  data:".'"Procesos="'."+".$array_s['ID_Peticiones']."+".'"&Cedula="'."+".$info[0]." +".'"&msg="+msg'." ,
                  success: function(data){
                   swal (".'"Listo"'." , ".'"El Reclamo fue Rechasada"'." , ".'"success"'.");  
                    $(".'"#a'.$Cedula.'"'.").addClass(".'"invi"'.");  
                  } 
             });;'>  </button>  </tr>"; 
    echo    $html;
