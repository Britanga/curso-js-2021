...
// list.insertBefore(newElement, list.children[1]) Inserta el elemento antes del 1
...
//list.after(list.cloneNode(true)) Se suele hacer cuando tenemos un elemento q se va a repetir en varios sitios y no tiene id
