...
let cadenaMayus = cadena.toUpperCase(); Guarda la cadena en mayusculas
...
/* Mayusculas y Minusculas son utiles a la hora de validar formularios */
...
console.log(cadena.endsWith('Mundo')); Evalua tanto 1 caracter como 1 palabra entera*/
...
/* Frase mezclando palabras con variables 1era forma */
console.log("Hola " + nombre + " " + apellido + ". Tienes " + (edad+1) + " años.");

/* Frases mezclando palabras con variables con Template Strings */
