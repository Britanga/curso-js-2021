...
// .textContent para acceder al texto del elemento html
const text = document.getElementById('text').textContent
// Creando expresión regular
const regEx = /lorem/gi
const regEx2 = new RegExp('lorem', 'gi') // 2da forma
const regEx3 = new RegExp('/lorem/', 'gi') // 3era forma

// Comprueba si es true o false la expresión regular
console.log(regEx.test(text))
// 2da forma sin expresiones regulares
