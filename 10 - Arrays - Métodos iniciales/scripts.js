...
//console.log(numbers);
//let deleteElement = numbers.shift(); Podemos guardar el elemento eliminado en una variable
//console.log(numbers);
//console.log(deleteElement); Y aqui mostramos el elemento eliminado
//console.log(numbers);
//numbers.pop(); Al igual q en .pop() pero esta vez no se hizo
//console.log(numbers);
...
//console.log(numbers);
//Podemos guardar la nueva longitud del elemento en una variable
//let newLength = numbers.push(6);
//console.log(numbers);
//console.log(newLength); Y aqui mostramos la nueva longitud del elemento
//let newLength2 = numbers.unshift(0); Al igual q en .unshift()
//console.log(numbers);
