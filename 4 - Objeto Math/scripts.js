...
console.log(Math.round(Math.random()*100)); /* N° pseudoaleatorio entre 0 y 100 */

//console.log(Math.random() * (max - min)+min);

console.log(Math.round(Math.random() * (100 - 50)+50)); /*N° pseudoaleatorio entre 50 y 100*/

console.log(Math.sign(0)); // -1 | 0 | 1 Sirve para saber si un N° es - o +
